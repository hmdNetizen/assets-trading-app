...
function General_setting() {
  ...
  const [englishEnableAutolanguage, setEnglishEnableAutolanguage] =
    useState("");
  ...
  const url =
    "https://trade-backend-daari.ondigitalocean.app/api/site/generalsettings";
  const onSaved = () => {
    setLoading(true);
    axios
        ...
        <div className="public-card">
          <div className="each-row dash-row">
            <div className="dtls">
              ...
              <p>It's recommended to use a SVG logo for increase the quality</p>
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions">
              <img className="logo" src={siteLogoWhite} alt="Logo" />
              <input
                type="file"
                name="siteLogo"
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions">
              <img className="logo" src={siteFav} alt="Logo" />
              <input
                type="file"
                name="siteFav"
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  onChange={(e) =>
                    setMaintenanceMode(e.target.checked ? true : false)
                  }
                  type="radio"
                ...
                <input
                  onChange={(e) =>
                    setMaintenanceMode(e.target.checked ? false : true)
                  }
                  type="radio"
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  onChange={(e) =>
                    setSwitchChartTradingView(e.target.checked ? true : false)
                  }
                  type="radio"
                  ...
                  defaultValue="yes"
                  // defaultChecked
                  checked={switchChartTradingView === true ? true : false}
                />
                <label htmlFor="switch-charts-one">ON</label>
                <input
                  onChange={(e) =>
                    setSwitchChartTradingView(e.target.checked ? false : true)
                  }
                  type="radio"
                  id="switch-charts-two"
                  name="switch-charts"
                  defaultValue="no"
                  checked={switchChartTradingView === false ? true : false}
                />
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  onChange={(e) =>
                    setAllowUsersswitchView(e.target.checked ? true : false)
                  }
                  type="radio"
                  id="allow-user-one"
                  name="allow-user"
                  defaultValue="yes"
                  // defaultChecked
                  checked={allowUsersswitchView === true ? true : false}
                />
                <label htmlFor="allow-user-one">ON</label>
                <input
                  onChange={(e) =>
                    setAllowUsersswitchView(e.target.checked ? false : true)
                  }
                  type="radio"
                  id="allow-user-two"
                  name="allow-user"
                  defaultValue="no"
                  checked={allowUsersswitchView === false ? true : false}
                />
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions">
              <input
                onChange={(e) => setStartWatchUserSignUp(e.target.value)}
          ...
          <div className="each-row dash-row">
            <div className="dtls">
              <h4>Starting watching list pair when new user signup</h4>
            ...
            <div className="actions">
              <textarea
                onChange={(e) => setStartWatchNewUserSignUp(e.target.value)}
                className="dash-text-area"
                defaultValue={""}
                value={startWatchNewUserSignUp}
        ...
        <div className="public-card">
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  ...
                  name="auto-language"
                  defaultValue="yes"
                  checked={englishEnableAutolanguage === true ? true : false}
                />
                ...
                <input
                  ...
                  name="auto-language"
                  defaultValue="no"
                  checked={englishEnableAutolanguage === false ? true : false}
                />
          ...
          <div className="each-row dash-row">
            <div className="dtls">
              ...
              <p>
                Editor link :{" "}
                <a target="_blank" href="https://poeditor.com" rel="noreferrer">
                  https://poeditor.com
                </a>
              </p>
            </div>
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  onChange={(e) =>
                    setEnablePOEditorLanguage(e.target.checked ? true : false)
                  }
                  type="radio"
                  ...
                  defaultValue="yes"
                  // defaultChecked
                  checked={enablePOEditorLanguage === true ? true : false}
                />
                <label htmlFor="po-editor-language-one">ON</label>
                <input
                  onChange={(e) =>
                    setEnablePOEditorLanguage(e.target.checked ? false : true)
                  }
                  type="radio"
                  id="po-editor-language-two"
                  name="po-editor-language"
                  defaultValue="no"
                  checked={enablePOEditorLanguage === false ? true : false}
                />
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions">
              <p className="small">
                You need to enable POEditor, set your API Key access and save
                for select your project
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  onChange={(e) =>
                    setEnableGoogleAds(e.target.checked ? true : false)
                  }
                  type="radio"
                  id="google-ad-one"
                  name="google-ad"
                ...
                <input
                  onChange={(e) =>
                    setEnableGoogleAds(e.target.checked ? false : true)
                  }
                  type="radio"
                  id="google-ad-two"
                  name="google-ad"
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  onChange={(e) =>
                    setEnableCookiePopup(e.target.checked ? true : false)
                  }
                  type="radio"
                  id="cookie-popup-one"
                  name="cookie-popup"
                ...
                <input
                  onChange={(e) =>
                    setEnableCookiePopup(e.target.checked ? false : true)
                  }
                  type="radio"
                  id="cookie-popup-two"
                  name="cookie-popup"
              ...
              <Select
                ...
                defaultValue={
                  adminData && adminData.blacklistedCountries
                    ? adminData.blacklistedCountries.map((e) => e)
                    : null
                }
                ...
                {countryList &&
                  countryList.map((country) => (
                    <Option
                      ...
                      label={country}
                    >
                      <div className="demo-option-label-item">{country}</div>
                    </Option>
                  ))}
              </Select>
            </div>
