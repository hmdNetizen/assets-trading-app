...
function GeneralAppearance() {
  ...
  const url =
    "https://trade-backend-daari.ondigitalocean.app/api/site/generalappearance";
  const onSaved = () => {
    setLoading(true);
    axios
          ...
          <div className="each-row dash-row">
            ...
            <div className="actions">
              ...
              >
                ...
                <option value="Top, horizontal">Top, horizontal</option>
              </select>
            </div>
          </div>
          <div className="each-row dash-row">
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  ...
                  // defaultChecked
                  onChange={(e) =>
                    setuserCanChangeTheme(e.target.checked ? true : false)
                  }
                ...
                <input
                  ...
                  defaultValue="no"
                  onChange={(e) =>
                    setuserCanChangeTheme(e.target.checked ? false : true)
                  }
                  checked={userCanChangeTheme === false ? true : false}
                />
              ...
              <div className="actions switch-field">
                <div className="switch-field-round">
                  <input
                    ...
                    // defaultChecked
                    onChange={(e) =>
                      setshowTimeInFooter(e.target.checked ? true : false)
                    }
                  ...
                  <input
                    onChange={(e) =>
                      setshowTimeInFooter(e.target.checked ? false : true)
                    }
                    checked={showTimeInFooter === false ? true : false}
                    type="radio"
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  ...
                  // defaultChecked
                  onChange={(e) =>
                    setshowContactInFooter(e.target.checked ? true : false)
                  }
                  checked={showContactInFooter === true ? true : false}
                />
                <label htmlFor="contact-in-footer-one">ON</label>
                <input
                  onChange={(e) =>
                    setshowContactInFooter(e.target.checked ? false : true)
                  }
                  checked={showContactInFooter === false ? true : false}
                  type="radio"
            ...
            <div className="actions switch-field">
              <div className="switch-field-round">
                <input
                  ...
                  // defaultChecked
                  onChange={(e) =>
                    setshowCalcaulator(e.target.checked ? true : false)
                  }
                ...
                <input
                  ...
                  defaultValue="no"
                  onChange={(e) =>
                    setshowCalcaulator(e.target.checked ? false : true)
                  }
